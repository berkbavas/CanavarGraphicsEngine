...
bool Canavar::Simulator::Aircraft::OnKeyPressed(QKeyEvent* pEvent)
{
    mPressedKeys.insert((Qt::Key) pEvent->key());
    return ShouldHandleKeyPress((Qt::Key) pEvent->key());
}

bool Canavar::Simulator::Aircraft::OnKeyReleased(QKeyEvent* pEvent)
{
...
void Canavar::Simulator::Aircraft::ProcessInputs()
{
    if (IsKeyPressed(Qt::Key_Up) || IsKeyPressed(Qt::Key_W))
        mElevator += 0.025;
    else if (IsKeyPressed(Qt::Key_Down) || IsKeyPressed(Qt::Key_S))
        mElevator -= 0.025;
    ...
    if (IsKeyPressed(Qt::Key_Left) || IsKeyPressed(Qt::Key_A))
        mAileron -= 0.025;
    else if (IsKeyPressed(Qt::Key_Right) || IsKeyPressed(Qt::Key_D))
        mAileron += 0.025;
...
bool Canavar::Simulator::Aircraft::ShouldHandleKeyPress(Qt::Key Key) const
{
    return ShouldHandleKey(Key);
}

bool Canavar::Simulator::Aircraft::ShouldHandleKeyRelease(Qt::Key Key) const
{
    return ShouldHandleKey(Key);
}

bool Canavar::Simulator::Aircraft::ShouldHandleKey(Qt::Key Key) const
{
    return Key == Qt::Key_Up || Key == Qt::Key_Down || Key == Qt::Key_Left || Key == Qt::Key_Right || //
           Key == Qt::Key_W || Key == Qt::Key_S || Key == Qt::Key_A || Key == Qt::Key_D ||            //
           Key == Qt::Key_Z || Key == Qt::Key_C ||                                                    //
           Key == Qt::Key_Plus || Key == Qt::Key_Minus;                                               //
}

bool Canavar::Simulator::Aircraft::IsKeyPressed(Qt::Key Key) const
{

...
const QVector3D &Canavar::Engine::AABB::GetCenter() const
{
    return mCenter;
}

const QMatrix4x4 &Canavar::Engine::AABB::GetTransformation() const
{
    return mTransformation;
}

const QVector3D &Canavar::Engine::AABB::GetMin() const
{
    return mMin;
}

const QVector3D &Canavar::Engine::AABB::GetMax() const
{
    return mMax;
}

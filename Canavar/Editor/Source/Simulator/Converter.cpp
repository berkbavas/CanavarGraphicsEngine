...
QVector3D Converter::ConvertPositionToCartesian(double latitude, double longitude, double altitude)
{
...
QQuaternion Converter::ConvertRotation(double latitude, double longitude, const QQuaternion& localToBody)
{

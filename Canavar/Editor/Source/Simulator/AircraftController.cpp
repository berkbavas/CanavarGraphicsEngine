...
AircraftController::AircraftController(Aircraft* aircraft, QObject* parent)
    ...
    , mTimeElapsed(0.0f)
{
    connect(this, &AircraftController::Command, mAircraft, &Aircraft::ProcessCommand, Qt::QueuedConnection);
...
bool AircraftController::Initialize()
{
...
void AircraftController::DrawImGui()
{
...
void AircraftController::SetJetNode(Canavar::Engine::ModelPtr pJetNode)
{
    mJetNode = pJetNode;
}